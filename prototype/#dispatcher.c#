...
/* queue_bytes: puts bytes that can't be sent immediately
 * on a queue to send later (i.e. when the next ACK is
 * received).
 */
...
/* unqueue_bytes: tries to send any bytes previously deferred
 * by a call to queue_bytes.
 */
...
/* schedule: decides how many packets to send and over which flow.
 *
